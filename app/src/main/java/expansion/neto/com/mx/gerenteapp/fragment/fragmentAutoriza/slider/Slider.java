package expansion.neto.com.mx.gerenteapp.fragment.fragmentAutoriza.slider;
...
public class Slider extends FrameLayout {
    ...
    public OnSlideChangeListener2 onSlideChangeListener2;
    ...
    public void onImageSlideChange(int position) {
        onSlideChangeListener2.setOnSlideChange(position);
    ...
    public void onSlideChangeListener2(OnSlideChangeListener2 onSlideChangeListener2) {
        this.onSlideChangeListener2 = onSlideChangeListener2;
    }
    ...
    private void startTimer() {
        if (config.slideChangeInterval > 0) {
            stopTimer();
            timer = new Timer();
            timer.schedule(new Slider.SliderTimerTask(), config.slideChangeInterval, config.slideChangeInterval);
        }
    }
    ...
    public static void init(ImageLoadingService imageLoadingService) {
        ss.com.bannerslider.Slider.imageLoadingService = imageLoadingService;
    }
