package expansion.neto.com.mx.gerenteapp.utils.font;
		...
		switch (typeface) {
			...
			case Roboto.ROBOTO_BOLD:
				if (Roboto.sRobotoBold == null) {
					Roboto.sRobotoBold = Typeface.createFromAsset(context.getAssets(), "fonts/Helvetica-Bold.otf");
				}
			...
			case Roboto.ROBOTO_LIGHT:
				if (Roboto.sRobotoLight == null) {
					Roboto.sRobotoLight = Typeface.createFromAsset(context.getAssets(), "fonts/HelveticaNeue.ttf");
				}
			...
			case Roboto.ROBOTO_REGULAR:
				if (Roboto.sRobotoRegular == null) {
					Roboto.sRobotoRegular = Typeface.createFromAsset(context.getAssets(), "fonts/HelveticaNeue.ttf");
				}
				return Roboto.sRobotoRegular;
			case Roboto.ROBOTO_THIN:
				if (Roboto.sRobotoThin == null) {
					Roboto.sRobotoThin = Typeface.createFromAsset(context.getAssets(), "fonts/HelveticaNeue.ttf");
				}
				return Roboto.sRobotoThin;
			case Roboto.ROBOTO_THIN_ITALIC:
				if (Roboto.sRobotoThinItalic == null) {
					Roboto.sRobotoThinItalic = Typeface.createFromAsset(context.getAssets(), "fonts/HelveticaNeue.ttf");
				}
