...
public class RestUrl {
    ...
    public static String REST_ACTION_GUARDA_TODO_TIPO_DOCUMENTO = "http://"+ ip +"/"+ dominioImagenesWS +"/cloudinaryset/";
    ...
    public static String REST_ACTION_ANALISTA_CALIDAD_OPERATIVA = "http://"+ ip +"/"+ dominio +"/evaluamd/";


    public static String REST_ACTION_CONSULTAR_RADIOS = "http://"+ ip +"/"+ dominio +"/consultaRadioxUsr/";

    public static String REST_ACTION_CAMBIA_ESTATUS_RADIOS = "http://"+ ip +"/"+ dominio +"/rechazoRadioGerente/";
