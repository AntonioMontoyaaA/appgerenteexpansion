...
public class AdapterListaGeneradoresTianguis extends RecyclerView.Adapter<AdapterListaGeneradoresTianguis.ListaviewHolder> {

    private List<CompetenciasGeneradoresV2.Tiangui> listas_im;
    Context context;
    private AdapterListaGeneradoresTianguis.OnItemClick mCallback;

    public AdapterListaGeneradoresTianguis(List<CompetenciasGeneradoresV2.Tiangui> listas_im, Context fm
            , AdapterListaGeneradoresTianguis.OnItemClick listener){
