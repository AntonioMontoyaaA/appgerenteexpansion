...
public class FragmentInicioRechazadas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titulo.setText(getString(R.string.mdsRechazadas));
    ...
    private void setupViewPager(ViewPager viewPager) {
        FragmentInicioRechazadas.ViewPagerAdapter adapter = new FragmentInicioRechazadas.ViewPagerAdapter(getSupportFragmentManager());
