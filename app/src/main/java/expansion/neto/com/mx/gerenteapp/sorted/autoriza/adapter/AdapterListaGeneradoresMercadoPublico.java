...
public class AdapterListaGeneradoresMercadoPublico extends RecyclerView.Adapter<AdapterListaGeneradoresMercadoPublico.ListaviewHolder> {

    private List<CompetenciasGeneradoresV2.MercadoPublico> listas_im;
    Context context;
    private AdapterListaGeneradoresMercadoPublico.OnItemClick mCallback;

    public AdapterListaGeneradoresMercadoPublico(List<CompetenciasGeneradoresV2.MercadoPublico> listas_im, Context fm
            , AdapterListaGeneradoresMercadoPublico.OnItemClick listener){
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mCallback.onClick(listas_im.get(position).getGeneradorId(), listas_im.get(position).getNombreGenerador(),
                        listas_im.get(position).getNivelId());                selectedPosition=position;
