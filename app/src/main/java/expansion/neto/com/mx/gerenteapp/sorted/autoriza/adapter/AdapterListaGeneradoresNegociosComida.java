...
public class AdapterListaGeneradoresNegociosComida extends RecyclerView.Adapter<AdapterListaGeneradoresNegociosComida.ListaviewHolder> {

    private List<CompetenciasGeneradoresV2.NegociosDeComida> listas_im;
    Context context;
    private AdapterListaGeneradoresNegociosComida.OnItemClick mCallback;

    public AdapterListaGeneradoresNegociosComida(List<CompetenciasGeneradoresV2.NegociosDeComida> listas_im, Context fm
            , AdapterListaGeneradoresNegociosComida.OnItemClick listener){
