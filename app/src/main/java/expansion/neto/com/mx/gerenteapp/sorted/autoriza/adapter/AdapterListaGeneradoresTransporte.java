...
public class AdapterListaGeneradoresTransporte extends RecyclerView.Adapter<AdapterListaGeneradoresTransporte.ListaviewHolder> {

    private List<CompetenciasGeneradoresV2.TransportePublico> listas_im;
    Context context;
    private AdapterListaGeneradoresTransporte.OnItemClick mCallback;

    public AdapterListaGeneradoresTransporte(List<CompetenciasGeneradoresV2.TransportePublico> listas_im, Context fm
            , AdapterListaGeneradoresTransporte.OnItemClick listener){
